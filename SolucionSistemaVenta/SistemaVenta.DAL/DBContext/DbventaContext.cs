...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            {
                entity.HasKey(e => e.IdCategoria).HasName("PK__Categori__8A3D240C20F88A24");
            ...
            {
                entity.HasKey(e => e.IdCliene).HasName("PK__Cliente__C1961B3C5A9A7040");
                ...
                entity.HasOne(d => d.RegimenNavigation).WithMany(p => p.Clientes)
                    ...
                    .HasConstraintName("FK__Cliente__Regimen__5AEE82B9");
            });
            ...
            {
                entity.HasKey(e => e.IdDetalleVenta).HasName("PK__DetalleV__BFE2843FF3800822");
                ...
                entity.HasOne(d => d.IdVentaNavigation).WithMany(p => p.DetalleVenta)
                    ...
                    .HasConstraintName("FK__DetalleVe__idVen__5BE2A6F2");
            });

            modelBuilder.Entity<Menu>(entity =>
            {
                entity.HasKey(e => e.IdMenu).HasName("PK__Menu__C26AF483DC74DE8B");
            ...
            {
                entity.HasKey(e => e.IdNegocio).HasName("PK__Negocio__70E1E107A8AE3880");
                ...
                entity.HasOne(d => d.RegimenNavigation).WithMany(p => p.Negocios)
                    .HasForeignKey(d => d.Regimen)
                    .HasConstraintName("FK__Negocio__Regimen__6E01572D");
            });

            modelBuilder.Entity<NumeroCorrelativo>(entity =>
            {
                entity.HasKey(e => e.IdNumeroCorrelativo).HasName("PK__NumeroCo__25FB547E357C5A0E");
            ...
            {
                entity.HasKey(e => e.IdProducto).HasName("PK__Producto__07F4A132E4617661");
            ...
            {
                entity.HasKey(e => e.CRegimenFiscal).HasName("PK__RegimenF__62E8C57812FEFF89");
            ...
            {
                entity.HasKey(e => e.IdRol).HasName("PK__Rol__3C872F766BA18F91");
            ...
            {
                entity.HasKey(e => e.IdRolMenu).HasName("PK__RolMenu__CD2045D87353D5C3");
                ...
                entity.HasOne(d => d.IdMenuNavigation).WithMany(p => p.RolMenus)
                    ...
                    .HasConstraintName("FK__RolMenu__idMenu__60A75C0F");

                entity.HasOne(d => d.IdRolNavigation).WithMany(p => p.RolMenus)
                    .HasForeignKey(d => d.IdRol)
                    .HasConstraintName("FK__RolMenu__idRol__619B8048");
            });

            modelBuilder.Entity<TipoDocumentoVenta>(entity =>
            {
                entity.HasKey(e => e.IdTipoDocumentoVenta).HasName("PK__TipoDocu__A9D59AEE80D2B00A");
            ...
            {
                entity.HasKey(e => e.CClaveUnidad).HasName("PK__Unidades__81D22EBB08DDBB5F");
            ...
            {
                entity.HasKey(e => e.IdUsuario).HasName("PK__Usuario__645723A6A8F13BB9");
                ...
                entity.HasOne(d => d.IdRolNavigation).WithMany(p => p.Usuarios)
                    .HasForeignKey(d => d.IdRol)
                    .HasConstraintName("FK__Usuario__idRol__628FA481");
            });

            modelBuilder.Entity<Venta>(entity =>
            {
                entity.HasKey(e => e.IdVenta).HasName("PK__Venta__077D5614E391CC99");
                ...
                entity.HasOne(d => d.IdTipoDocumentoVentaNavigation).WithMany(p => p.Venta)
                    ...
                    .HasConstraintName("FK__Venta__idTipoDoc__6383C8BA");
